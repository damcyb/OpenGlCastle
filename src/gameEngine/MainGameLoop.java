...
//        texturedHay.getTexture().setReflectivity(1);
        ...
        Light light = new Light(new Vector3f(1000,1000,1000), new Vector3f(0.4f,0.4f,0.4f));


        //Light light = new Light(new Vector3f(0,1000,100), new Vector3f(1f,1f,1f));
        List<Light> lights = new ArrayList<Light>();
        lights.add(light);
        lights.add(new Light(new Vector3f(53, 0f, -130), new Vector3f(0.03f,0.03f,0), new Vector3f(0.01f, 0.01f, 0.002f)));
